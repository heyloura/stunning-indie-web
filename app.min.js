...
const _app = {
    ...
    post: {
      toggleInputs: function(type) {
        ...
        if (type === "article") {
          byId(_app.htmlIds.postTitle).style.display = "block";
          byId(_app.htmlIds.postSummary).style.display = "block";
          document.querySelector(`[for='${_app.htmlIds.postTitle}']`).style.display = "block";
          document.querySelector(`[for='${_app.htmlIds.postSummary}']`).style.display = "block";
        }
      },
      hide: function() 
      {
        ...
        byId(_app.htmlIds.postSummary).style.display = "none";
        document.querySelector(`[for='${_app.htmlIds.postSummary}']`).style.display = "none";
      },
      clear: function() {
      ...
      set: function(id, title, domain, url, name, tags, content, created, type, summary) {
        ...
        document.querySelector(`input[name="${_app.htmlIds.postTypes}"][value="${type}"]`).checked = true;
        _app.post.toggleInputs(type);
      },
      getCreated: function() {
        return byId(_app.htmlIds.postCreated).value;
      },
      getUrl: function() {
      ...
      getSummary: function() {
        return byId(_app.htmlIds.postSummary).value;
      },
...
// }📑
  ...
  function autoSave() { 
    if(byId(_app.htmlIds.githubRepo).value) {
