...
const _app = {
    ...
    post: {
      ...
      set: function(id, title, domain, url, name, tags, content, created, type) {
...
// }
  ...
  function generatePostHTML(html, type, id, created, updated) {
    ...
    return {
        ...
        body: `<article class="h-entry">
          ${authorDisp}
          <div class="title">published on ${publishedDisp}</div>
          <div class="e-content">               
              ${html}     
          </div>    
          ${footer}
  ...
  function edit(id) {
    ...
    if (postEl) {
      ...
      _app.post.set(id, title, domain, url, name, tags, content, created, type);
    }
